...
public final class SlickToAndroidKeycodes {
    static HashMap b;
    static HashMap c;
    static HashMap<String,Object> d = a(SlickCodes.class);
    static HashMap e = a(AndroidCodes.class);
    static HashMap f = a(GdxCodes.class);
    static HashMap a = a("slickToAndroidCodes", d, e);
    ...
    private static HashMap a(String str, HashMap<String,Object> hashMap, HashMap hashMap2) {
        ...
        if (arrayList.size() != 0) {
            ...
            k1104.d(str + ": Could not find keycode for: " + str3);
        }
        return hashMap3;
    }
    ...
    static {
        ...
        for (String str : d.keySet()) {
            ...
            a.get(Integer.valueOf(intValue));
    ...
    public static int a(String str) throws MissingKey {
        String upperCase = str.toUpperCase();
        Integer num = (Integer) e.get(upperCase);
        if (num == null) {
            throw new MissingKey("Could not find key:".concat(String.valueOf(upperCase)));
        }
        return num.intValue();
    }
}
